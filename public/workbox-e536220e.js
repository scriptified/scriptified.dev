define('./workbox-e536220e.js', ['exports'], function (exports) {
  'use strict';
        ...
        responsePromise = responsePromise.catch(err => {
          {
            ...
            logger.groupCollapsed(
              `Error thrown when responding to: ` + ` ${getFriendlyURL(url)}. Falling back to Catch Handler.`
            );
...
//# sourceMappingURL=workbox-e536220e.js.map
