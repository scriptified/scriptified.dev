...
export default function ThankYou(): JSX.Element {
  ...
  return (
    ...
    >
      <section className="min-h-75 max-w-4xl px-8 sm:px-8 md:px-8 lg:px-8 mx-auto text-lg leading-normal pt-16">
        <Text type="h1" color={`text-${theme}-900`} additionalStyles="text-4xl pb-8 text-center">
